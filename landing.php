...
<div class=e64_42>
    ...
    <div class=e68_85>
        ...
        <ui  class="e64_50">
            ...
            <li>Keep track of birthday, anniversaries and other special events </li> </ui>
    </div>
    <div class=e68_86>
    ...
    <div class=e68_87>
        ...
        <button type="button" value="create page" onclick="log_page()" class="e64_21">Click here to log in to an account </button>
    </div>
    <script type="text/JavaScript">
