...
// passes those values to userCheck, and either dispalys the dashboard button or an error screen
function log(){
  ...
  //  user.value = ""; pass.value = "";
    ...
    if (valid){
        ...
        //* there should be a function here that creates a token to continously validate log in information going foward
...
function userCheck(username, password){
    ...
    //* with the database and validates the username and pasword, that function should return a boolean value
    let valid = true
    return valid;
}
...
function sign(){
    ...
    if (uValid && pValid){
        ...
        //This else section needs to be expanded after we come up with rulse for username and password
        document.getElementById("bad").removeAttribute("hidden");
        document.getElementById("bad-button").removeAttribute("hidden");
    }
}
...
function hide() {
    ...
    document.getElementById("bad").setAttribute("hidden","");
